...
pub struct Purchase<'info> {
    ...
    // Escrow vault containing the listed NFT
    #[account(
        mut,
    ...
    // Platform reward token mint for incentives
    #[account(
        mut,
    ...
    // Closes listing account and returns rent to seller after purchase
    #[account(
        mut,
        close = maker,                     
    ...
    // Platform treasury for collecting transaction fees
    #[account(
...
impl<'info> Purchase<'info> {                                                   
    // Handles SOL payment distribution between seller and platform
    ...
    // Transfers NFT from escrow to buyer's wallet
    ...
    // Cleans up escrow vault and refunds rent to seller
